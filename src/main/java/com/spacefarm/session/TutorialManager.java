...
public class TutorialManager {
    ...
    private void initSteps() {
        steps.add(new Step("Вітаємо, Фермере!", "Ласкаво просимо на Eden Prime. Ваша місія — відновити життя на цій планеті. Готові розпочати навчання?", TaskType.INFO, true));
        ...
        steps.add(new Step("Світове Дерево", "Відкрийте меню Світового Дерева в центрі бази та закрийте його, щоб побачити прогрес відновлення атмосфери.", TaskType.OPEN_TREE_MENU, false));
        steps.add(new Step("Скавенджинг", "Знайдіть поклади кристалів у пустелі та розпочніть пошук. Кристали потрібні для торгівлі з дроном. Дочекайтеся появи кристала в інвентарі.", TaskType.SCAVENGE_CRYSTAL, false));
        steps.add(new Step("Консоль Дрона", "Відкрийте консоль торгового дрона на краю бази та закрийте її. Тут ви зможете обмінювати ресурси.", TaskType.OPEN_DRONE_CONSOLE, false));
